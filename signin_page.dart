//This sign in page works perfectly well.
//It needs adjustment to make the screen flacid
//The sign in with google, phoneauth and email
//It also has has other sign in methods that will need API keys from the providers
