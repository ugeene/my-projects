...
class PlaceMarkerBodyState extends State<PlaceMarkerBody> {
  ...
  static final LatLng center = const LatLng(-0.1084439, 34.2655483);
  ...
  //This creates a marker with a custom bitmap image
  void _add(LatLng pos) {
    ...
    //The line below has been modified to use a custom marker
    final Marker marker = Marker(
      icon: BitmapDescriptor.fromAsset('assets/bitmap/mipmap-hdpi/bitmapdesc.png'),
      markerId: markerId,

      //The line below has been modified to use values passed to the function
